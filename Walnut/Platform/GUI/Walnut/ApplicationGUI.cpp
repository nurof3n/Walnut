...
static VkPhysicalDeviceRayTracingPipelinePropertiesKHR    g_RayTracingPipelineProperties    = {};
static VkPhysicalDeviceAccelerationStructurePropertiesKHR g_AccelerationStructureProperties = {};

// Ray tracing function pointers (defined as extern in VulkanRayTracing.h)
...
static void SetupVulkan(const char** extensions, uint32_t extensions_count)
{
    ...
    // Create Vulkan Instance
    {
        ...
        appInfo.pApplicationName   = "Walnut Application";
        appInfo.applicationVersion = VK_MAKE_VERSION(1, 0, 0);
        appInfo.pEngineName        = "Walnut";
    ...
    // Create Logical Device (with 1 queue)
    {
        ...
        // Enable buffer device address (required for acceleration structures)
        ...
        rtFeature.pNext              = &asFeature;
        rtFeature.rayTracingPipeline = VK_TRUE;

        // Enable Vulkan 1.4 dynamic rendering features
        VkPhysicalDeviceDynamicRenderingFeatures dynamicRenderingFeature = {};
        dynamicRenderingFeature.sType            = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_FEATURES;
        dynamicRenderingFeature.pNext            = &rtFeature;
        ...
        // Load ray tracing extension functions
        pvkGetBufferDeviceAddressKHR
                = (PFN_vkGetBufferDeviceAddressKHR) vkGetDeviceProcAddr(g_Device, "vkGetBufferDeviceAddressKHR");
        pvkCreateAccelerationStructureKHR = (PFN_vkCreateAccelerationStructureKHR) vkGetDeviceProcAddr(
                g_Device, "vkCreateAccelerationStructureKHR");
        pvkDestroyAccelerationStructureKHR = (PFN_vkDestroyAccelerationStructureKHR) vkGetDeviceProcAddr(
                g_Device, "vkDestroyAccelerationStructureKHR");
        pvkGetAccelerationStructureBuildSizesKHR = (PFN_vkGetAccelerationStructureBuildSizesKHR) vkGetDeviceProcAddr(
                g_Device, "vkGetAccelerationStructureBuildSizesKHR");
        pvkGetAccelerationStructureDeviceAddressKHR
                = (PFN_vkGetAccelerationStructureDeviceAddressKHR) vkGetDeviceProcAddr(
                        g_Device, "vkGetAccelerationStructureDeviceAddressKHR");
        pvkCmdBuildAccelerationStructuresKHR = (PFN_vkCmdBuildAccelerationStructuresKHR) vkGetDeviceProcAddr(
                g_Device, "vkCmdBuildAccelerationStructuresKHR");
        pvkBuildAccelerationStructuresKHR = (PFN_vkBuildAccelerationStructuresKHR) vkGetDeviceProcAddr(
                g_Device, "vkBuildAccelerationStructuresKHR");
        pvkCreateRayTracingPipelinesKHR
                = (PFN_vkCreateRayTracingPipelinesKHR) vkGetDeviceProcAddr(g_Device, "vkCreateRayTracingPipelinesKHR");
        pvkGetRayTracingShaderGroupHandlesKHR = (PFN_vkGetRayTracingShaderGroupHandlesKHR) vkGetDeviceProcAddr(
                g_Device, "vkGetRayTracingShaderGroupHandlesKHR");
        pvkCmdTraceRaysKHR = (PFN_vkCmdTraceRaysKHR) vkGetDeviceProcAddr(g_Device, "vkCmdTraceRaysKHR");
    }
...
static void FrameRender(Walnut::Application* application, ImGui_ImplVulkanH_Window* wd, ImDrawData* draw_data)
{
    ...
    }
    {
        ...
        // These use g_MainWindowData.FrameIndex and not s_CurrentFrameIndex because they're tied to the swapchain image
        // index
...
#include "Walnut/Embed/WindowImages.embed"
    ...
    void Application::Init()
    {
        ...
        m_WindowHandle = glfwCreateWindow(
                m_Specification.Width, m_Specification.Height, m_Specification.Name.c_str(), NULL, NULL);
        ...
        if (m_Specification.CenterWindow) {
            ...
            glfwSetWindowAttrib(
                    m_WindowHandle, GLFW_RESIZABLE, m_Specification.WindowResizeable ? GLFW_TRUE : GLFW_FALSE);
        }
    ...
    void Application::UI_DrawTitlebar(float& outTitlebarHeight)
    {
        ...
        ImGui::BeginHorizontal(
                "Titlebar", { ImGui::GetWindowWidth() - windowPadding.y * 2.0f, ImGui::GetFrameHeightWithSpacing() });
...

        {
            ...
            ImGui::SetCursorPos(
                    ImVec2(ImGui::GetWindowWidth() * 0.5f - textSize.x * 0.5f, 2.0f + windowPadding.y + 6.0f));
    ...
    void Application::UI_DrawMenubar()
    {
        ...
        if (m_Specification.CustomTitlebar) {
            const ImRect menuBarRect
                    = { ImGui::GetCursorPos(), { ImGui::GetContentRegionAvail().x + ImGui::GetCursorScreenPos().x,
    ...
    {
        if (!m_Specification.UseDockspace)
            WL_CORE_WARN_TAG("Application",
                    "Application::SetMenubarCallback - ApplicationSpecification::UseDockspace is false to menubar will "
                    "not be visible.");
    ...
    {
        return g_RayTracingPipelineProperties;
    }

    VkPhysicalDeviceAccelerationStructurePropertiesKHR Application::GetAccelerationStructureProperties()
    {
        return g_AccelerationStructureProperties;
    }
